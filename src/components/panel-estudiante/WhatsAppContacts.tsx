...
const CONTACTS = [
  {
    label: 'Soporte',
    description: 'Dudas generales y ayuda',
    phone: '573007654321',
    message: 'Hola, soy estudiante de LGS y necesito ayuda.',
  },
  {
    label: 'Academico',
    description: 'Clases, niveles y horarios',
    phone: '573001234567',
    message: 'Hola, tengo una consulta academica.',
  },
  {
    label: 'Facturacion',
    description: 'Pagos y estados de cuenta',
    phone: '573009876543',
    message: 'Hola, tengo una consulta sobre facturacion.',
  },
]
