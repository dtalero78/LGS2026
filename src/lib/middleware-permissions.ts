...
export const ROUTE_PERMISSIONS: Record<string, Permission[]> = {
  ...
  '/dashboard/informes/sesiones/calendario-sesiones-jumps': ['INFORMES.PROGRAMACION' as Permission],
  '/dashboard/informes/sesiones/calendario-training-clubs': ['INFORMES.PROGRAMACION' as Permission],
  '/dashboard/informes/sesiones/calendario-welcome':        ['INFORMES.PROGRAMACION' as Permission],
  ...
  '/dashboard/informes/advisors/essential': ['INFORMES.ADVISORS' as Permission],
