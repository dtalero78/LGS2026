...
export enum PersonPermission {
  ...
  /** Editar nombres/apellidos del beneficiario. Se propaga a 6 tablas. */
  EDITAR_NOMBRE = 'PERSON.INFO.EDITAR_NOMBRE',
  /** Editar el numeroId: es la LLAVE que une PEOPLE con ACADEMICA y el login. */
  EDITAR_NUMERO_ID = 'PERSON.INFO.EDITAR_NUMERO_ID',
  AGREGAR_BENEFICIARIO = 'PERSON.INFO.AGREGAR_BENEFICIARIO',
  WHATSAPP = 'PERSON.INFO.WHATSAPP',
  ELIMINAR = 'PERSON.INFO.ELIMINAR',
  RESUMEN_FINANCIERO_VER = 'PERSON.FINANCIERA.RESUMEN_VER',
  INFO_PAGOS_VER         = 'PERSON.FINANCIERA.INFO_PAGOS_VER',
  ...
  ESTADO_CUENTA          = 'PERSON.FINANCIERA.ESTADO_CUENTA',
  ...
  PAGOS_EDITAR           = 'PERSON.FINANCIERA.PAGOS_EDITAR',
...
export enum StudentPermission {
  // Globales
  FRANQUICIA_SENCE = 'STUDENT.GENERAL.FRANQUICIA_SENCE',
...
export enum AcademicoPermission {
  ...
  PERFORMANCE_EVAL_POR_ADVISOR = 'ACADEMICO.PERFORMANCE_EVAL.POR_ADVISOR',
  PERFORMANCE_EVAL_LISTA       = 'ACADEMICO.PERFORMANCE_EVAL.LISTA',
  PERFORMANCE_EVAL_BUSQUEDA_COMENTARIO = 'ACADEMICO.PERFORMANCE_EVAL.BUSQUEDA_COMENTARIO',
...
export enum ServicioPermission {
  ...
  // Exam. Intern. > SetUp Ciclo y Agrupación
  EXAM_INTERN_SETUP_VER              = 'SERVICIO.EXAM_INTERN.SETUP_VER',
  EXAM_INTERN_SETUP_GENERAR         = 'SERVICIO.EXAM_INTERN.SETUP_GENERAR',
  EXAM_INTERN_AGRUPACION_AGENDAR    = 'SERVICIO.EXAM_INTERN.AGRUPACION_AGENDAR',

  // Cancelación sin reemplazo
  CANCELACION_SIN_REEMPLAZO_VER = 'SERVICIO.CANCELACION_SIN_REEMPLAZO.VER',
}
...
export enum MantenimientoPermission {
  ...
  DRIVE_CONFIG      = 'MANTENIMIENTO.CONTRATOS.DRIVE_CONFIG',
  KIDS_CONFIG       = 'MANTENIMIENTO.CONTRATOS.KIDS_CONFIG',
  BIENVENIDA_CONFIG = 'MANTENIMIENTO.CONTRATOS.BIENVENIDA_CONFIG',
  CARGAR_BENEFICIARIOS = 'MANTENIMIENTO.CONTRATOS.CARGAR_BENEFICIARIOS',
  // Contingencia
  CONTINGENCIA_WHATSAPP = 'MANTENIMIENTO.CONTINGENCIA.WHATSAPP',
  // Usuarios
  ...
  CREAR_LOGIN       = 'MANTENIMIENTO.USUARIOS.CREAR_LOGIN',
  // Avisos
  AVISOS_TICKER     = 'MANTENIMIENTO.AVISOS.TICKER',
  AVISOS_BANNER     = 'MANTENIMIENTO.AVISOS.BANNER',
  AVISOS_REGLAMENTOS = 'MANTENIMIENTO.AVISOS.REGLAMENTOS',
  // Material
...
export enum AprobacionPermission {
  ...
  // Acción: borrar contrato NO aprobado + todos sus registros (cascade + snapshot en PURGE_LOG)
  CENTRO_BORRAR = 'APROBACION.CENTRO.BORRAR',
