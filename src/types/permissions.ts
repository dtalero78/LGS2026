...
export enum AcademicoPermission {
  ...
  // Informes — acceso general al módulo
  ...
  // Informes — grupos individuales
  INFORMES_ASISTENCIA = 'ACADEMICO.INFORMES.ASISTENCIA',
  INFORMES_PROGRAMACION = 'ACADEMICO.INFORMES.PROGRAMACION',
  INFORMES_ADVISORS = 'ACADEMICO.INFORMES.ADVISORS',
  INFORMES_USUARIOS = 'ACADEMICO.INFORMES.USUARIOS',
  INFORMES_CONTRATOS = 'ACADEMICO.INFORMES.CONTRATOS',
  INFORMES_PLANTA = 'ACADEMICO.INFORMES.PLANTA',
  INFORMES_ESTADISTICAS = 'ACADEMICO.INFORMES.ESTADISTICAS',
}
