...
export const PERMISSIONS_CATALOG: PermissionDefinition[] = [
  ...
  {
    code: AcademicoPermission.INFORMES_ASISTENCIA,
    module: Module.ACADEMICO,
    section: 'Informes',
  ...
  {
    code: AcademicoPermission.INFORMES_PROGRAMACION,
    module: Module.ACADEMICO,
    section: 'Informes',
  ...
  {
    code: AcademicoPermission.INFORMES_ADVISORS,
    module: Module.ACADEMICO,
    section: 'Informes',
    name: 'Grupo "Advisors"',
  ...
  {
    code: AcademicoPermission.INFORMES_USUARIOS,
    module: Module.ACADEMICO,
    section: 'Informes',
    name: 'Ítem "Usuarios"',
  ...
  {
    code: AcademicoPermission.INFORMES_CONTRATOS,
    module: Module.ACADEMICO,
    section: 'Informes',
    name: 'Ítem "Contratos"',
  ...
  {
    code: AcademicoPermission.INFORMES_PLANTA,
    module: Module.ACADEMICO,
    section: 'Informes',
    name: 'Grupo "Planta"',
  ...
  {
    code: AcademicoPermission.INFORMES_ESTADISTICAS,
    module: Module.ACADEMICO,
    section: 'Informes',
