...
export const PERMISSIONS_CATALOG: PermissionDefinition[] = [
  ...
  // ========== INFORMES MODULE ==========
  {
    ...
    section: 'Informes',
    name: 'Módulo "Informes" (acceso general)',
    description: 'Acceso al módulo de informes',
  },
  {
    code: InformesPermission.BENEFICIARIOS,
    module: Module.INFORMES,
    section: 'Informes',
  ...
  {
    code: InformesPermission.EXPORTAR,
    module: Module.INFORMES,
    section: 'Informes',
  ...
  {
    code: InformesPermission.ASISTENCIA,
    module: Module.INFORMES,
    section: 'Informes',
    name: 'Grupo "Asistencia"',
    description: 'Acceso a informes de asistencia (Sesiones, Clubes, Complementarias, Welcome, X País)',
  },
  {
    code: InformesPermission.PROGRAMACION,
    module: Module.INFORMES,
    section: 'Informes',
    name: 'Grupo "Programación"',
    description: 'Acceso a informes de programación (Sesiones, Clubes, Welcome)',
  },
  {
    code: InformesPermission.ADVISORS,
    module: Module.INFORMES,
    section: 'Informes',
    name: 'Grupo "Advisors"',
  ...
  },
  {
    ...
    section: 'Informes',
    name: 'Ítem "Usuarios"',
    description: 'Acceso al informe de usuarios',
  },
  {
    code: InformesPermission.CONTRATOS,
    module: Module.INFORMES,
    section: 'Informes',
    name: 'Ítem "Contratos"',
    description: 'Acceso al informe de contratos',
  },
  {
    code: InformesPermission.PLANTA,
    module: Module.INFORMES,
    section: 'Informes',
    name: 'Grupo "Planta"',
    description: 'Acceso a informes de planta (Advisors, Administrativos)',
  },
  {
    code: InformesPermission.ESTADISTICAS,
    module: Module.INFORMES,
    section: 'Informes',
    name: 'Ítem "Estadísticas"',
